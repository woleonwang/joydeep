 ...
 * @LastEditTime: 2022-06-12 22:29:27
 * @LastEditors: wmy
 * @Description: 功能描述
 */
...
import MobileDevelopers from './components/mobile';
        ...
        <div className={styles.block}>
          <div className={styles.left}>
            ...
            <div className={styles.body}>
              我们已经进入到一个远程优先的世界，全球各地的公司都在世界各地招聘
              <br />
              最优秀的程序员。但目前大部分的中国程序员还很难接触到这些机会，
              <br />
              我们希望填补这个空白，让中国的优秀程序员告别内卷，获得全世界最
              <br />
              优秀公司的远程工作机会。
            </div>
      ...
      <div className={classnames(styles.blockWrapper)}>
        <div className={classnames(styles.block, styles.second)}>
          ...
          <div className={styles.secondBody}>
            Landd上的远程职位来自于世界各地的优秀科技公司。
            <br />
            无需主动投递工作申请，我们会主动为你匹配合适的机会。
            <br />
            一次通过面试，终生有效。我们会在你的职业生涯里持续为你推荐合适的工作机会。
          </div>
          <Link href='/developers/faq'>
            <a>
              <div
                style={{ position: 'relative' }}
                className={styles.blackGhostBtn}
              >
                了解更多
              </div>
            </a>
      ...
      <div className={classnames(styles.blockWrapper)}>
        <div className={styles.generalBlock}>
          <div className={styles.left}>
            ...
            <div className={styles.body}>
              作为互联网发展最热的趋势，有非常多的 Web3 公司在 Landd
              招聘，如果你对 Web3 感兴趣，想加入世界各地的 Web3
              公司，请别犹豫，立即加入Landd 吧！
            </div>
...
Developers.layout = DeveloperUnlogginLayout;
